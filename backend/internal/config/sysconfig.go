...
type SysConfig struct {
	...
	// MaxSessionsPerDay is the maximum number of sessions per notebook a user can have per day.
	...
	OAuthAuthority string `env:"LEXFORGE_AUTH0_DOMAIN,notEmpty,required"`
	OAuthAudience  string `env:"LEXFORGE_AUTH0_AUDIENCE,notEmpty,required"`
}
